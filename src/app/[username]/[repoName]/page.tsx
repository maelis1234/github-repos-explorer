...
export default async function RepositoryDetailPage({
  ...
  return (
    <div className='flex flex-col space-y-4 mt-4 items-center w-full max-w-[70%] lg:max-w-[50%]'>
      <RepositoryDetailCard repo={repositoryData} />
      <Link href={'/'} className=''>
        <div className='flex flex-row items-center text-gray-900 hover:underline hover:underline-offset-2 hover:text-gray-500'>
